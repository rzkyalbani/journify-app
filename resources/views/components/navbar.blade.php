<nav class="flex justify-between bg-[#40A2E3] text-white text-lg px-16 py-4 items-center">
    ...
    <div class="flex items-center gap-8 text-zinc-300">
        @auth
            <a href="#" class="text-white hover:text-gray-300 text-sm">My Posts</a>
            ...
            <form action="/logout" method="POST" class="ml-8">
                @csrf
                <button type="submit" class="text-gray-600 hover:text-black bg-[#FFF6E9] px-3 py-2 rounded-sm text-sm flex items-center gap-x-1">
        ...
        @guest
            <a href="/login" class="text-gray-600 hover:text-black bg-[#FFF6E9] px-3 py-2 rounded-sm text-sm flex items-center gap-x-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
